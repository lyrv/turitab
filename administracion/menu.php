      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= baseURL ?>/administracion/viajes/crear">Crear Viaje</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?= baseURL ?>/administracion/pasajeros/alta">Registrar Pasajeros</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= baseURL ?>/administracion/chofer">CHOFER</a></li>
            <li><a href="<?= baseURL ?>/administracion/autobus">AUTOBUS</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?= baseURL ?>/administracion/terminal">TERMINAL</a></li>
          </ul>
        </li>
      </ul>
